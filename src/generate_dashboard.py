...
<body>
    ...
    <section class="hero">
        ...
        <div class="hero-card">
            <small>Maximum demand coverage</small>
            <h2>{best_turbine}</h2>
            <small>best-performing turbine model can supply</small>
    ...
    <main class="container">
        ...
        <section class="kpi-grid">
            ...
            <div class="card kpi">
                <div class="icon">≈</div>
                <div>
                    <div class="kpi-label">Maximum demand coverage</div>
            ...
            <div class="card kpi">
                <div class="icon">▥</div>
                <div>
                    <div class="kpi-label">Maximum annual generation</div>
                    <div class="kpi-value">{format_number(best_generation)} MWh</div>
                    <div class="kpi-note">Best-performing turbine model</div>
                </div>
            </div>
        ...
        <section class="demand-grid">
            <div class="card">
                ...
                <div class="demand-kpi-grid">
                    ...
                    <div class="demand-kpi">
                        ...
                        <strong>100% aligned</strong>
                        <small>
                            Synthetic annual demand calibrated to Aalborg Portland reported consumption
                        </small>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="sub">
                    ...
                    The synthetic demand profile assumes relatively stable industrial operations throughout the year.
                </div>
        ...
        <section class="main-grid">
            ...
            <div class="card">
                ...
                <div class="sub">
                    Comparison between industrial electricity demand and wind generation
                    during the first 14 days of the analysis period.
                </div>
                <div class="legend">
                    <span>Demand MW</span>
        ...
        <section class="info-grid">
            <div class="card info-card">
                ...
                <div>
                    ...
                    <p>
                        ...
                        The framework is intended for industrial decision support and scenario
                        assessment rather than precise energy production forecasting.
                    </p>
                </div>
            </div>
            ...
            <div class="card info-card">
                ...
                <div>
                    <h2>Method</h2>
                    <p>
                        The hourly demand profile is synthetic because public hourly electricity
                        consumption data is not available, but its annual total is calibrated to
                        Aalborg Portland's reported electricity consumption.
                    </p>
                </div>
            </div>
